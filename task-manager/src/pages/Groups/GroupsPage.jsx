    ...
    return (
      <Card 
        ...
        style={{ 
          ...
          border: isCreator ? '1px solid #7c4dff30' : '1px solid #1890ff30'
        }}
        bodyStyle={{ padding: '0' }}
      ...
      >
        <div style={{ 
          ...
          background: isCreator ? 'linear-gradient(135deg, #b388ff15 0%, #7c4dff15 100%)' : 'linear-gradient(135deg, #1890ff15 0%, #096dd915 100%)'
        }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <Avatar 
                ...
                icon={<TeamOutlined />} 
                style={{ 
                  backgroundColor: isCreator ? '#7c4dff' : '#1890ff',
                  boxShadow: isCreator ? '0 2px 10px rgba(124, 77, 255, 0.4)' : '0 2px 10px rgba(24, 144, 255, 0.4)'
                }} 
              />
        ...
        <div style={{ padding: '16px 20px' }}>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <UserOutlined style={{ color: '#8c8c8c', marginRight: '5px' }} />
              <Text type="secondary">{group.members.length} miembros</Text>
            </div>
            <div style={{ display: 'flex', alignItems: 'center' }}>
              <CalendarOutlined style={{ color: '#8c8c8c', marginRight: '5px' }} />
              <Text type="secondary">
